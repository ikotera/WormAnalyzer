...
set(InputFig,'Position',getnicedialoglocation2(FigPos,get(InputFig,'Units')));
...
setdefaultbutton2(InputFig, OKHandle);
...
% Key press function to push OK button by hitting enter key
